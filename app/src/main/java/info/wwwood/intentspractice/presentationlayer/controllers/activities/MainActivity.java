...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button main_btDialer = (Button) findViewById((R.id.main_btDialer));
        main_btDialer.setOnClickListener(this); //IMPLEMENTEM CONTROLADORA DE CLICKS
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.main_btGPS:
                ...
                break;
            case R.id.main_btDialer:
                intent=new Intent(this,DialerActivity.class); // li dius quina classe s'ha d'executar al clickar el botó main_btWeb
                break;
